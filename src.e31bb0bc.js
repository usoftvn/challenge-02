...
var CONTRACT_NAME = "hello.daothang.testnet";
...
function clearMessages() {
  ...
  objMessages.innerHTML = "Please enter the name and click \"Say hello\" button to start!";
}

window.clearMessages = clearMessages;

function getRandomColor() {
  var colors = ["red", "orange", "green", "blue", "magenta", "purple", "black", "maroon", "brown"];
...
function appendMessage(message) {
  ...
  var html = "<div style=\"padding-top: 5px;\"><span style=\"font-size: smaller;\">".concat(strDate, "</span>: <font color=\"").concat(color, "\">").concat(message, "</font></div>");
  var objMessages = document.querySelector("#messages");

  if (isFirstMessage) {
    objMessages.innerHTML = html;
  } else {
    var oldHtml = objMessages.innerHTML;
    objMessages.innerHTML = html + oldHtml;
  }
...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var _event$target$element, fieldset, greeting, message;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 3;
            _context.next = 6;
            return window.contract.hello({
              account_id: greeting.value
            });
          ...
          case 18:
            ...
            submitButton.disabled = true; // show notification
